(defproject teeth "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :figwheel {:on-jsload "teeth.core/on-js-reload"}

                :compiler {:main teeth.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/teeth.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/teeth.js"
                           :main teeth.core
